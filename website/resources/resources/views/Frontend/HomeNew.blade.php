            ...
            <g mask="url(#m)">
                ...
                <foreignObject x="50" y="100" width="600" height="800">
                    ...
                    <div xmlns="http://www.w3.org/1999/xhtml" style="padding-right: 60px;">
                        ...
                        <p class="sec-para" style="color:#797E88; font-size:20px; line-height:28px;">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit, illum. Consectetur sint
                            eveniet, provident optio nihil deleniti vitae vel, adipisci temporibus ut eaque, culpa
                            est
                            fuga iste! Inventore, provident vitae?
                        </p>
                        <a href="" class="th-btn black-border th-icon th-radius p-3">
                            Read More
                        </a>
                    </div>
                </foreignObject>
                ...
                <!-- Right Side: Image -->
                <foreignObject x="600" y="100" width="600" height="800">
                    <div xmlns="http://www.w3.org/1999/xhtml"
                        style="width:100%; height:100%; display:flex; align-items:start; justify-content:center;">
                        <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb" alt="Adventure"
                            style="max-width:90%; border-radius:10px; box-shadow:0 10px 20px rgba(0,0,0,0.1);" />
                    </div>
                </foreignObject>
            </g>
