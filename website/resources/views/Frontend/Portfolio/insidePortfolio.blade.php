...
@section('content')
    <main id="brand">
        <section style="margin-top:68px;">
            <div class="full-width">
                <picture>
                    ...
                    <img src="{{ asset('frontend-assets/img/banners/portfolio.jpg') }}" class="w-100" alt="">
                </picture>
            </div>
        </section>
        ...
        <section class="space brand-sec bg-smoke2 overflow-hidden shape-mockup-wrap" id="brand-list">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6 col-md-4 d-flex justify-content-center align-items-center box" data-aos="zoom-in"
                        ...
                        <a href="{{ route('social_media', ['client' => 'stemrx-bioscience']) }}">
                            <img src="{{ asset('frontend-assets/img/work/banner/stemrx.jpg') }}"
                                alt="Stemrx Bioscience Logo" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-6 col-md-4 d-flex justify-content-center align-items-center box d-none"
                        data-aos="zoom-in" data-aos-delay="100" data-aos-duration="1000" data-aos-easing="ease-in-out">
                    ...
                    <div class="col-6 col-md-4 d-flex justify-content-center align-items-center box" data-aos="zoom-in"
                        ...
                        <a href="{{ route('social_media', ['client' => 'bulid-track']) }}">
                            <img src="{{ asset('frontend-assets/img/work/build track/Buildtrack.jpg') }}"
                                alt="BUILD TRACK" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-6 col-md-4 d-flex justify-content-center align-items-center box" data-aos="zoom-in"
                        data-aos-delay="100" data-aos-duration="1000" data-aos-easing="ease-in-out">
                    ...
                    <div class="col-6 col-md-4 d-flex justify-content-center align-items-center box" data-aos="zoom-in"
                        ...
                        <a href="{{ route('social_media', ['client' => 'team-cashless-india']) }}">
                            <img src="{{ asset('frontend-assets/img/work/team-cashless-india/1.jpg') }}"
                                alt="Team Cashleass India" class="img-fluid">
                        </a>
                    </div>
                    ...
                    <div class="col-6 col-md-4 d-flex justify-content-center align-items-center box" data-aos="zoom-in"
                        ...
                        <a href="{{ route('social_media', ['client' => 'hollywood-opticians']) }}">
                            <img src="{{ asset('frontend-assets/img/work/hollywood-opticians/1.jpg') }}"
                                alt="Hollywood Opticians" class="img-fluid">
                        </a>
                    </div>
                    <div class="col-6 col-md-4 d-flex justify-content-center align-items-center box" data-aos="zoom-in"
                        data-aos-delay="100" data-aos-duration="1000" data-aos-easing="ease-in-out">
