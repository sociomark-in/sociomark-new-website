                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-xxl-8 col-lg-8">
                                    <div class="page-content">
                                        <h2 class="h2 page-title mb-20" data-aos="fade-left" data-aos-duration="3000">WHY
                                            <span class="text-blue">MAKE A MARK</span> WITH
                                            US?
                                        </h2>
                                        <p class="blog-text"><b>Sociomark’s team adds great value to each project by
                                                bringing in a cumulative experience of 30 years.</b>

                                        </p>
                                        <p class="blog-text mb-30"> Targeting the correct audience, getting you to the top
                    ...
                    <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item px-10" role="presentation">
                            <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="pills-contact" aria-selected="false">Print Media</button>
                        </li>
                    </ul>
