...
@section('content')
<main>
    <div class="breadcumb-wrapper " data-bg-src="{{ asset('frontend-assets/img/case-study/lime_logo.png') }}">
        <div class="container">
    ...
    <div class="container space">
        ...
        <ul>
            ...
            <li>What if we relate the marketing efforts through our senses?</li>
            <li>Creating a trending format that represents #MarketingIsBusiness</li>
        </ul>
        ...
        <ul>
            <div class="row">
                <div class="col-sm-6 col-12 imgs">
                    <p class="sec-para">It is the smell that does the magic!</p>
                    <iframe class="instagram-media instagram-media-rendered" id="instagram-embed-4" src="https://www.instagram.com/p/CK1cF4fpb0r/embed/captioned/?cr=1&amp;v=13&amp;wp=400&amp;rd=https%3A%2F%2Fwww.sociomark.in&amp;rp=%2Fcase-study%2Flime#%7B%22ci%22%3A4%2C%22os%22%3A2030.800000011921%2C%22ls%22%3A243.5%2C%22le%22%3A409.80000001192093%7D" allowtransparency="true" allowfullscreen="true" frameborder="0" height="928" data-instgrm-payload-id="instagram-media-payload-4" scrolling="no" style="background: white; max-width: 540px; width: calc(100% - 2px); border-radius: 3px; border: 1px solid rgb(219, 219, 219); box-shadow: none; display: block; margin: 0px 0px 12px; min-width: 326px; padding: 0px;"></iframe>
                    <script async="" src="//www.instagram.com/embed.js"></script>
                </div>
                <div class="col-sm-6 col-12 imgs">
                    <p class="sec-para">Pulled by the trick or the taste?</p>
                    <iframe class="instagram-media instagram-media-rendered" id="instagram-embed-5" src="https://www.instagram.com/p/CKqExXLpcuX/embed/captioned/?cr=1&amp;v=13&amp;wp=400&amp;rd=https%3A%2F%2Fwww.sociomark.in&amp;rp=%2Fcase-study%2Flime#%7B%22ci%22%3A5%2C%22os%22%3A2122.800000011921%2C%22ls%22%3A243.5%2C%22le%22%3A409.80000001192093%7D" allowtransparency="true" allowfullscreen="true" frameborder="0" height="1000" data-instgrm-payload-id="instagram-media-payload-5" scrolling="no" style="background: white; max-width: 540px; width: calc(100% - 2px); border-radius: 3px; border: 1px solid rgb(219, 219, 219); box-shadow: none; display: block; margin: 0px 0px 12px; min-width: 326px; padding: 0px;"></iframe>
                    <script async="" src="//www.instagram.com/embed.js"></script>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-12 imgs">
                    <p class="sec-para">Ring any bells?</p>
                    <iframe class="instagram-media instagram-media-rendered" id="instagram-embed-6" src="https://www.instagram.com/p/CKiWEXRJdjv/embed/captioned/?cr=1&amp;v=13&amp;wp=400&amp;rd=https%3A%2F%2Fwww.sociomark.in&amp;rp=%2Fcase-study%2Flime#%7B%22ci%22%3A6%2C%22os%22%3A2772.800000011921%2C%22ls%22%3A243.5%2C%22le%22%3A409.80000001192093%7D" allowtransparency="true" allowfullscreen="true" frameborder="0" height="832" data-instgrm-payload-id="instagram-media-payload-6" scrolling="no" style="background: white; max-width: 540px; width: calc(100% - 2px); border-radius: 3px; border: 1px solid rgb(219, 219, 219); box-shadow: none; display: block; margin: 0px 0px 12px; min-width: 326px; padding: 0px;"></iframe>
                    <script async="" src="//www.instagram.com/embed.js"></script>
                </div>
                <div class="col-sm-6 col-12 imgs">
                    <p class="sec-para">We did it, Joe!</p>
                    <iframe class="instagram-media instagram-media-rendered" id="instagram-embed-7" src="https://www.instagram.com/p/CKWgFZrJwsl/embed/captioned/?cr=1&amp;v=13&amp;wp=400&amp;rd=https%3A%2F%2Fwww.sociomark.in&amp;rp=%2Fcase-study%2Flime#%7B%22ci%22%3A7%2C%22os%22%3A3545.4000000059605%2C%22ls%22%3A243.5%2C%22le%22%3A409.80000001192093%7D" allowtransparency="true" allowfullscreen="true" frameborder="0" height="874" data-instgrm-payload-id="instagram-media-payload-7" scrolling="no" style="background: white; max-width: 540px; width: calc(100% - 2px); border-radius: 3px; border: 1px solid rgb(219, 219, 219); box-shadow: none; display: block; margin: 0px 0px 12px; min-width: 326px; padding: 0px;"></iframe>
                    <script async="" src="//www.instagram.com/embed.js"></script>
                </div>
            </div>
        </ul>
        ...
        <ul>
            <div class="row">
                <div class="col-sm-6 col-12 imgs">
                    <p class="sec-para">Creativity that resulted in business</p>
                    <iframe class="instagram-media instagram-media-rendered" id="instagram-embed-8" src="https://www.instagram.com/p/CKx24Ucl_Oq/embed/captioned/?cr=1&amp;v=13&amp;wp=400&amp;rd=https%3A%2F%2Fwww.sociomark.in&amp;rp=%2Fcase-study%2Flime#%7B%22ci%22%3A8%2C%22os%22%3A3729.800000011921%2C%22ls%22%3A243.5%2C%22le%22%3A409.80000001192093%7D" allowtransparency="true" allowfullscreen="true" frameborder="0" height="982" data-instgrm-payload-id="instagram-media-payload-8" scrolling="no" style="background: white; max-width: 540px; width: calc(100% - 2px); border-radius: 3px; border: 1px solid rgb(219, 219, 219); box-shadow: none; display: block; margin: 0px 0px 12px; min-width: 326px; padding: 0px;"></iframe>
                    <script async="" src="//www.instagram.com/embed.js"></script>
                </div>
                <div class="col-sm-6 col-12 imgs">
                    <p class="sec-para">Trending Format</p>
                    <iframe class="instagram-media instagram-media-rendered" id="instagram-embed-9" src="https://www.instagram.com/p/CMBpTCPFM5F/embed/captioned/?cr=1&amp;v=13&amp;wp=400&amp;rd=https%3A%2F%2Fwww.sociomark.in&amp;rp=%2Fcase-study%2Flime#%7B%22ci%22%3A9%2C%22os%22%3A4639.5999999940395%2C%22ls%22%3A243.5%2C%22le%22%3A409.80000001192093%7D" allowtransparency="true" allowfullscreen="true" frameborder="0" height="802" data-instgrm-payload-id="instagram-media-payload-9" scrolling="no" style="background: white; max-width: 540px; width: calc(100% - 2px); border-radius: 3px; border: 1px solid rgb(219, 219, 219); box-shadow: none; display: block; margin: 0px 0px 12px; min-width: 326px; padding: 0px;"></iframe>
                    <script async="" src="//www.instagram.com/embed.js"></script>
                </div>
            </div>
        </ul>
        ...
        <div class="row">
            <div class="col-sm-12 nos">
                <!--									<div class="row">-->
                <p class="sec-para">With a purely organic approach, the campaign hashtag was pushed from 10 to 1000+ over the span of just one week and the creators alone achieved</p>
                <!--									</div>-->
                <div class="row">
                    <div class="col-sm-4 col-md-4 col-12 nos">
                        <h3 class="fs-3 text-blue">3.2L</h3>
                        <p class="sec-para">IMPRESSIONS</p>
                    </div>
                    <div class="col-sm-4 col-md-4 col-12 nos">
                        <h3 class="fs-3 text-blue">2.6L</h3>
                        <p class="sec-para">REACH</p>
                    </div>
                    <div class="col-sm-4 col-md-4 col-12 nos">
                        <h3 class="fs-3 text-blue">25k+</h3>
    ...
    <div class="header-button mb-5 d-flex align-items-center justify-content-center">
        <a href="{{ route('social_media', ['client'=>'lime']) }}" class="th-btn th-icon">View Portfolio</a>
    </div>
