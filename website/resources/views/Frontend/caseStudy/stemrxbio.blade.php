...
<main>
    ...
    <div class="container space">
        ...
        <ul>
            <li class="sec-para">This brand delivers effective, high-quality products with a focus on safety and integrity.</li>
            <li class="sec-para">Committed to science and innovation, they research novel ingredients and use premium botanicals and Ayurvedic knowledge.</li>
            <li class="sec-para">They ensure transparency by sharing all product research online, blending traditional Indian herbs with modern science.</li>
        </ul>
