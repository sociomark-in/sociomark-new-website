                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="contact-form style2"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="contactNumber" class="sec-para">Full Name<span
                            ...
                            <div class="form-group col-md-6">
                                <label class="sec-para" for="email">Email Address<span
                                        class="text-danger">*</span></label>
                    ...
                    @enderror
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-3 form-group">
                                    <label for="countryCode" class="sec-para">Country Code<span
                                            class="text-danger">*</span></label>
                                    <select class="form-select" id="countryCode" name="countryCode">
                                        <option value="" disabled
                                            {{ old('countryCode') == '' ? 'selected' : '' }}>Select Code</option>
                                        <option value="+91" data-maxlength="10" data-currency="INR"
                                            {{ old('countryCode') == '+91' ? 'selected' : '' }}>India (+91)</option>
                                        <option value="+971" data-currency="AED"
                                            {{ old('countryCode') == '+971' ? 'selected' : '' }}>UAE (+971)</option>
                                ...
                                <div class="col-md-9 form-group">
                                    <label for="contactNumber" class="sec-para">Contact Number<span
                                            class="text-danger">*</span></label>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-select @error('timeline') is-invalid @enderror" id="timeline"
                                    name="timeline">
                                    <option disabled {{ old('timeline') ? '' : 'selected' }}>Choose an option</option>
                                    <option value="Immediately"
                                        {{ old('timeline') == 'Immediately' ? 'selected' : '' }}>Immediately</option>
                                    <option value="In 1–2 weeks"
                                        {{ old('timeline') == 'In 1–2 weeks' ? 'selected' : '' }}>In 1–2 weeks</option>
                                    <option value="In a month"
                                        {{ old('timeline') == 'In a month' ? 'selected' : '' }}>In a month</option>
