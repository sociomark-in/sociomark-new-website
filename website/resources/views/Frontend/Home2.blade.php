...
<main id="home">
    ...
    <section class="choose-area overflow-hidden mb-md-3 mt-md-3 mt-0 md-0 " id="about-sec2">
        <div class="container">
            <div class="row">
                <div class="col-xl-7 pe-5" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1200">
                    <div class="title-area mb-20">
                        <h2 class="sec-title ">The Powerful Lorem ipsum. <span class="text-orange"> Benefits of</span>
                            Saor SEO Lorem, ipsum.</h2>
                    </div>
                    <p class="sec-para ">In today's digital landscape, a strong online presence is critical for business
    ...
    <section class="overflow-hidden position-relative space-extra-top space-bottom garally" id="testi-sec">
        <div class="container">
            ...
            <div class="slider-area">
                <div class="swiper th-slider has-shadow" id="testiSlide1" data-slider-options='{"loop":true}'>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
