        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 p-0">
                    <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/Hero.png') }}" alt="" srcset="" width="100%">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row text-center">
                <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                    <div class="counter-card pb-2">
                        <h3 class="box-number text-orange"><span class="counter-number">30</span>k<span class="plus">+</span>
                        </h3>
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                    <div class="counter-card pb-2">
                        <h3 class="box-number text-orange"><span class="counter-number">3</span>B<span class="plus">+</span>
                        </h3>
                        <div class="media-body">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                    <div class="counter-card pb-2">
                        <h3 class="box-number text-orange"><span class="counter-number">20</span>K<span class="plus">+</span>
                        </h3>
                        <div class="media-body">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-6">
                    <div class="counter-card pb-2">
                        <h3 class="box-number text-orange"><span class="counter-number">50</span><span class="plus">+</span></h3>
                        <div class="media-body">
                ...
                <div class="col-md-6 text-center">
                    <div class="circle-wrapper" data-aos="fade-right" data-aos-delay="200" data-tilt data-tilt-max="10">
                        <div class="circle" data-tilt data-tilt-max="10">
                            <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/skills.png') }}" alt="Key" class="key-image mt-3">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="according-list-area">
                ...
                <div class="according-list hover-item">
                    ...
                    <div class="according-img">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/Service/Create with Purpose.png') }}" alt=""
                ...
                <div class="according-list hover-item">
                    ...
                    <div class="according-img">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/Service/Reach the Right People.png') }}" alt=""
                            class="rounded-overflow">
                    ...
                    <div class="choose-feature-wrap">
                        <div class="choose-feature">
                            <div class="box-icon d-flex justify-content-center align-items-center">
                                <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/creative.png') }}" width="60" alt="Icon" class="w-100 h-100">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="choose-feature">
                            <div class="box-icon d-flex justify-content-center align-items-center">
                                <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/Strategy.png') }}" width="60" alt="Icon" class="w-100 h-100">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="choose-feature">
                            <div class="box-icon d-flex justify-content-center align-items-center">
                                <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/Story.png') }}" width="60" alt="Icon" class="w-100 h-100">
                            </div>
                            <div class="media-body">
                ...
                <div class="col-xl-4" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1200"
                    ...
                    <div class="choose-image">
                        <div class="tilt-active">
                            ...
                            <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/content game.png') }}" alt="Choose" class="w-100">
    ...
    <section class="overflow-hidden space bg-grey" id="Features">
        <div class="container">
            ...
            <div class="row justify-content-evenly mt-5">
                <div class="col-12 col-md-3 feature d-flex align-items-center justify-content-start mt-3 mt-md-0">
                    <div class="icon-img me-3">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/website.png') }}" alt="One-Click Reports"
                            class="feature-icon">
                    </div>
                ...
                <div class="col-12 col-md-3 feature d-flex align-items-center justify-content-start mt-3 mt-md-0">
                    <div class="icon-img me-3">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/short_form.png') }}" alt="Traffic Performance"
                            class="feature-icon">
                    </div>
                ...
                <div class="col-12 col-md-3 feature d-flex align-items-center justify-content-start mt-3 mt-md-0">
                    <div class="icon-img me-3">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/Blog.png') }}" alt="CRM Module" class="feature-icon">
                    </div>
            ...
            <div class="row justify-content-evenly mt-3 mt-md-5">
                <div class="col-12 col-md-3 feature d-flex align-items-center justify-content-start mt-3 mt-md-0">
                    <div class="icon-img me-3">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/caption.png') }}" alt="Keyword Performance"
                            class="feature-icon">
                    </div>
                ...
                <div class="col-12 col-md-3 feature d-flex align-items-center justify-content-start mt-3 mt-md-0">
                    <div class="icon-img me-3">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Content Marketing/icons/banner.png') }}" alt="Marketing Activities"
                            class="feature-icon">
                    </div>
