                ...
                <div class="col-md-6 text-center">
                    <div class="circle-wrapper" data-aos="fade-right" data-aos-delay="200" data-tilt data-tilt-max="10">
                        <div class="circle" data-tilt data-tilt-max="10">
                            <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Magic.png') }}" alt="Key"
            ...
            <div class="according-list-area">
                <div class="according-list hover-item item-active">
                    ...
                    <div class="according-img">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Services/Understand the Brand Inside Out.png') }}" alt="" class="rounded-overflow">
                ...
                <div class="according-list hover-item">
                    ...
                    <div class="according-img">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Services/Study Competitors and Gaps.png') }}" alt="" class="rounded-overflow">
                ...
                <div class="according-list hover-item">
                    ...
                    <div class="according-img">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Services/Plan with Precision.png') }}" alt="" class="rounded-overflow">
                ...
                <div class="according-list hover-item">
                    ...
                    <div class="according-img">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Services/Create with Intent.png') }}" alt="" class="rounded-overflow">
                ...
                <div class="according-list hover-item">
                    ...
                    <div class="according-img">
                        <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Services/Execute and Optimise.png') }}" alt="" class="rounded-overflow">
                    ...
                    <div class="choose-feature-wrap">
                        <div class="choose-feature">
                            <div class="box-icon d-flex justify-content-center align-items-center">
                                <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Icons/Strategy.png') }}" width="60" alt="Icon">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="choose-feature">
                            <div class="box-icon d-flex justify-content-center align-items-center">
                                <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Icons/Expertise.png') }}" width="60" alt="Icon">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="choose-feature">
                            <div class="box-icon d-flex justify-content-center align-items-center">
                                <img src="{{ asset('frontend-assets/img/ServicePages/Digital marketing/Icons/Growth.png') }}" width="60" alt="Icon">
                            </div>
                            <div class="media-body">
