                ...
                <div class="row gy-5 ">
                    <div class="col-xl-5">
                        <div class=" pe-xl-4">
                            ...
                            <p class="sec-para">In today's digital age, a sth4ong online presence is no longer a luxury but
                                a necessity.
                            ...
                            <p class="sec-para">Our expertise spans a wide range of digital marketing services, including
                                Social Media
            ...
            <div class="container-fluid">
                ...
                <div class="portfolio-area">
                    <div class="row gy-4 justify-content-center filter-active">
                        <div class="col-12 col-md-6 col-xl-3 filter-item  cat5 cat7 cat3">
                            <div class="flip-box">
                        ...
                        <div class="col-12 col-md-6 col-xl-3 filter-item cat1 cat5 cat7 cat3">
                            <div class="flip-box">
                                <div class="flip-box-inner">
                                    <div class="flip-box-front">
                        ...
                        <div class="col-12 col-md-6 col-xl-3 filter-item cat1 cat2 cat5 cat7 cat3">
                            <div class="flip-box">
                                <div class="flip-box-inner">
                                    <div class="flip-box-front">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-grid">
                                            ...
                                            <div class="box-content">
                                                ...
                                                <h3 class="box-title"><a href="blog-details.html">6 Tips for Personal
                                                        Selling in
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-grid">
                                            ...
                                            <div class="box-content">
                                                ...
                                                <h3 class="box-title"><a href="blog-details.html">8 Things About Web
                                                        Design Your
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-grid">
                                            ...
                                            <div class="box-content">
                                                ...
                                                <h3 class="box-title"><a href="blog-details.html">How Chatbots Can Help
                                                        You
            ...
            <div class="container th-container">
                <div class="slider-area text-center">
                    <div class="swiper th-slider" id="brandSlider1"
                        data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"476":{"slidesPerView":"2"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"4"},"1200":{"slidesPerView":"5"},"1400":{"slidesPerView":"7"}}}'>
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item style2">
                                    <a href="">
                                        <img class="original w-75 h-100"
                                            src="https://www.sociomark.in/lp/assets/media/clients/buildtrack (1).png"
                                            alt="Brand Logo">
                                        <img class="gray w-75 h-100"
                                            src="https://www.sociomark.in/lp/assets/media/clients/buildtrack (1).png"
                                            alt="Brand Logo">
                                    </a>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="brand-item style2">
                                    <a href="">
                                        <img class="original w-75 h-100"
                                            src="https://www.sociomark.in/lp/assets/media/clients/euro.jpg"
                                            alt="Brand Logo">
                                        <img class="gray w-75 h-100"
                                            src="https://www.sociomark.in/lp/assets/media/clients/euro.jpg"
                                            alt="Brand Logo">
                            ...
                            <div class="swiper-slide">
                                <div class="brand-item style2">
                                    <a href="">
                                        <img class="original w-75 h-100"
                                            src="https://www.sociomark.in/lp/assets/media/clients/tataplay.png"
                                            alt="Brand Logo">
                                        <img class="gray w-75 h-100"
                                            src="https://www.sociomark.in/lp/assets/media/clients/tataplay.png"
                                            alt="Brand Logo">
