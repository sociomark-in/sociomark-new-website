            ...
            <div class="row align-items-end justify-content-center">
                ...
                <div class="col-lg-12 d-flex justify-content-center align-items-center flex-column">
                    <p class="mt-n2 mb-25 sec-para text-left" data-aos="fade-down" data-aos-delay="100"
                        data-aos-duration="1000" data-aos-easing="ease-in-out">We go beyond the ordinary. Every brand we work with gets a tailored, thoughtful strategy—because no two stories are the same. Whether it’s <strong>SEO, social media marketing,</strong> or <strong>web development,</strong> we listen, understand, and deliver what actually works.
                    </p>
                    <p class="mt-n2 mb-25 sec-para text-left" data-aos="fade-down" data-aos-delay="200"
                        data-aos-duration="1200" data-aos-easing="ease-in-out">As a full-suite <strong>digital marketing agency in UAE,</strong> we offer everything from performance marketing to creative strategy under one roof. Our focus is on real results and meaningful connections. Client satisfaction isn’t just a goal—it’s how we measure success. While others follow trends, we build lasting impact. That’s what makes us reMARKable.
                ...
                <div class="row g-3 g-md-4">
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="process-card">
                            ...
                            <div class="box-content">
                                <h3 class="box-title">Pick What You Need</h3>
                                <p class="box-text"> Choose the service that fits your brand’s current goals.
                                </p>
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="process-card">
                            ...
                            <div class="box-content">
                                <h3 class="box-title">Let’s Talk</h3>
                                <p class="box-text">We’ll schedule a call to align on vision, ideas, and execution.
                                </p>
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="process-card">
                            ...
                            <div class="box-content">
                                <h3 class="box-title">Watch It Come Alive</h3>
    ...
    <div class="overflow-hidden mb-md-3 mt-md-3 mt-0 md-0" id="about-process">
        <div class="container process-container text-center">
            <h2 class="fw-bold mb-5 sec-title" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1200"
                ...
                From Brief to <span class="text-blue"> Brilliance</span>
            </h2>
            <div class="row justify-content-center gy-5">
                ...
                <div class="col-md-3 process-step zig-down" data-aos="fade-up" data-aos-delay="300"
                    ...
                    <div class="text mt-1 mt-3">
                        <h3 class="sub-sec-title">Pick What You Need</h3>
                ...
                <div class="col-md-3 process-step d-flex flex-column-reverse flex-md-column zig-up" data-aos="fade-up"
                    ...
                    <div class="text">
                        <h3 class="sub-sec-title">Share Your Vision</h3>
                ...
                <div class="col-md-3 process-step zig-down" data-aos="fade-up" data-aos-delay="500"
                    ...
                    <div class="text mt-1 mt-3">
                        <h3 class="sub-sec-title">Let’s Talk</h3>
                ...
                <div class="col-md-3 process-step d-flex flex-column-reverse flex-md-column" data-aos="fade-up"
                    ...
                    <div class="text">
                        <h3 class="sub-sec-title">Watch It Come Alive</h3>
            ...
            <div class="image-gallery js-overlay gap-3 d-flex justify-content-center">
                ...
                <div class="position-relative">
                    ...
                    <div class="img-overlay h-100 p-3">
                        <!-- Top content -->
                        <div class="top-content desc-text d-none">
                            <a href="about.html" class="th-btn th-btn-white no-hover p-2 px-3 mt-2">Bold ideas</a>
                            <a href="about.html" class="th-btn th-btn-white no-hover p-2 px-3 mt-2">Creatives</a>
                            <a href="about.html" class="th-btn th-btn-white no-hover p-2 px-3 mt-2">Growth
                                mindset</a>
                            <a href="about.html" class="th-btn th-btn-white no-hover p-2 px-3 mt-2">People-first
                                culture</a>
                        </div>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-md-6 text-white p-4 ">
                    ...
                    <p class="sec-para" data-aos="fade-left" data-aos-delay="200" data-aos-duration="1200"
                        data-aos-easing="ease-in-out">Together, Mr. Vivek Baandal and Mrs. Heta Desai Baandal are dedicated to helping businesses grow in the digital space. What started during their college days has grown into a successful agency built on creativity and purpose.
                    </p>
                    <p class="sec-para" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1200"
                        data-aos-easing="ease-in-out">They’ve created an environment where ideas thrive, and collaboration leads the way. With a strong foundation and growing presence as a <strong>digital marketing company in UAE,</strong> they continue to guide brands toward better visibility and long-term success.
            ...
            <div class="row d-flex justify-content-center justify-content-md-end mt-4">
                ...
                <div class="col-md-6 col-12 pe-0 pe-md-5">
                    ...
                    <p class="sec-para" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1200"
                        data-aos-easing="ease-in-out">We’re more than a digital agency—we’re a mix of brains, bold moves, and brand love.
                        Rooted in the UAE and collaborating with brands across the globe, we bring fresh thinking to every brief.
                        Click through to discover what sets us apart.
                    </p>
                </div>
                <div class="col-12 col-md-3 first-feature-card feature-card flip-box p-0 mx-2" data-aos="fade-left"
                    ...
                    <div class="flip-box-inner h-100">
                        <div class="flip-box-front h-100 d-flex align-items-center justify-content-center flex-column">
                            <img src="{{ asset('frontend-assets/img/ourCulture/2.png') }}" alt=""
                                class="h-auto w-auto">
                            <h3 class="sub-sec-title mt-2"> Quality Content</h3>
                        </div>
                ...
                <div class="col-12 col-md-3 first-feature-card feature-card flip-box p-0 mx-2" data-aos="fade-left"
                    ...
                    <div class="flip-box-inner h-100">
                        <div class="flip-box-front h-100 d-flex align-items-center justify-content-center flex-column">
                            <img src="{{ asset('frontend-assets/img/ourCulture/2.png') }}" alt=""
                                class="h-auto w-auto">
                            <h3 class="sub-sec-title mt-2">Customized Strategy</h3>
                        </div>
                        <div class="flip-box-back d-flex justify-content-center align-items-center h-100">
                            <p class="sec-para">Strategy that speaks your brand’s language.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-3 second-feature-card feature-card flip-box p-0 mx-2">
                    <div class="flip-box-inner h-100">
                        <div class="flip-box-front h-100 d-flex align-items-center justify-content-center flex-column">
                            <img src="{{ asset('frontend-assets/img/ourCulture/2.png') }}" alt=""
                                class="h-auto w-auto">
                            <h3 class="sub-sec-title mt-2">Results-Driven</h3>
                        </div>
                        <div class="flip-box-back d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-12 col-md-3 second-feature-card feature-card flip-box p-0 mx-2" data-aos="fade-right"
                    ...
                    <div class="flip-box-inner h-100">
                        <div class="flip-box-front h-100 d-flex align-items-center justify-content-center flex-column">
                            <img src="{{ asset('frontend-assets/img/ourCulture/2.png') }}" alt=""
                                class="h-auto w-auto">
                            <h3 class="sub-sec-title mt-2">Creative Distinction</h3>
                        </div>
                        <div class="flip-box-back d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-12 col-md-3 second-feature-card feature-card flip-box p-0 mx-2" data-aos="fade-right"
                    ...
                    <div class="flip-box-inner h-100">
                        <div class="flip-box-front h-100 d-flex align-items-center justify-content-center flex-column">
                            <img src="{{ asset('frontend-assets/img/ourCulture/2.png') }}" alt=""
                                class="h-auto w-auto">
                            <h3 class="sub-sec-title mt-2">Collaborative Growth</h3>
                        </div>
                        <div class="flip-box-back d-flex justify-content-center align-items-center h-100">
