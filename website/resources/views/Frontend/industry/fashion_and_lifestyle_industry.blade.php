...
@section('content')
    <main id="industries">
        ...
        <section class="p-0" style="margin-top: 66px;">
            <div class="full-width">
                <img src="{{ asset('frontend-assets/img/industry/Fashion & Lifestyle.png') }}" alt="" srcset="" class="w-100" loading="lazy">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcumb-content breadcrumb-light">
                            <h1 class="breadcumb-title">Fashion & Lifestyle Industry</h1>
                            <ul class="breadcumb-menu">
                                <li><a href="{{ route('home') }}">Home</a></li>
                                <li><a href="{{ route('industry_home')}}">Industries</a></li>
                                <li>Fashion & Lifestyle Industry</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="title-area mb-25 mt-n1">
                            <h2 class="fw-bold sec-title" data-aos="zoom-in" data-aos-delay="100"
                                >Where Trends Meet Tech - <span class="text-blue">Digital Marketing</span> for Fashion & Lifestyle Brands</h2>
                        </div>
