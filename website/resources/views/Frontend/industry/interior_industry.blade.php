    ...
    <main id="industries">
        <section class="p-0" style="margin-top: 66px;">
            <div class="full-width">
                <img src="{{ asset('frontend-assets/img/industry/Home & Interior.png') }}" alt="" srcset="" class="w-100" loading="lazy">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcumb-content breadcrumb-light">
                            <h1 class="breadcumb-title">Home Interior Industry</h1>
                            <ul class="breadcumb-menu">
                                <li><a href="{{ route('home') }}">Home</a></li>
                                <li><a href="{{ route('industry_home') }}">Industries</a></li>
                                <li>Home Interior Industry</li>
                            </ul>
                        </div>
                    </div>
                </div>
