...
@section('content')
    <main id="industries">
        ...
        <section class="p-0" style="margin-top: 66px;">
            <div class="full-width">
                <img src="{{ asset('frontend-assets/img/industry/FMCG.png') }}" alt="" srcset="" class="w-100">
            </div>
        </section>
                    ...
                    <div class="col-lg-4 mb-30 mb-xl-0">
                        <div class="imgBox img-box2 me-xl-4 mt-lg-60">
                            <div class="img1 th-anim mb-35">
                                <img src="{{ asset('frontend-assets/img/industry/images/FMCG Industry.jpg') }}" class="w-100" alt="About">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
