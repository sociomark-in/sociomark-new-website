    ...
    <main id="industries">
        <section class="p-0" style="margin-top: 66px;">
            <div class="full-width">
                <img src="{{ asset('frontend-assets/img/industry/Gaming.png') }}" alt="" srcset="" class="w-100" loading="lazy">
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcumb-content breadcrumb-light">
                            <h1 class="breadcumb-title">Gaming Industry</h1>
                ...
                <div class="portfolio-area" data-aos="zoom-in" data-aos-delay="200">
                    <div class="row gy-4 filter-active garally-row-height mt-md-0 mt-4">
                        <div class="col-md-3 col-xl-auto filter-item cat5 cat1">
                            <a href="{{ route('nodwinGaming') }}" class="project-item d-block">
